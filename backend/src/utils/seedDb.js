...
async function seedDatabase() {
  ...
  try {
    ...
    const [weekId] = await db('weeks').insert({
      ...
      shifts.push(
        {
          ...
          start_time: i === 5 ? '9:00 AM' : '9:00 AM', // Saturday/Sunday morning
          end_time: i === 5 ? '3:00 PM' : '3:00 PM',
        ...
        },
        {
          ...
          start_time: i === 5 ? '3:00 PM' : '3:00 PM', // Saturday/Sunday evening
          end_time: i === 5 ? '9:00 PM' : '9:00 PM',
          status: i === 5 ? 'swap-proposed' : 'confirmed' // Saturday is swap proposed
        }
      );
    }
